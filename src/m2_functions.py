...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and John Johnson.
...
def main():
    ...
    print("We want to test Hypotenuse. We expect the next line to say 5.0")
    print(hypotenuse(3, 4))

    print("We expect 8.4704")
    print(hypotenuse(6.5, 5.4312))
